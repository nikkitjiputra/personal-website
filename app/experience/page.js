  ...
  return (
    <div>
        ...
        <div className="mt-10 mx-20">
            ...
            <h1 className="text-2xl ml-10 mt-5">TechStart Intern</h1>
            <h5 className="text-lg ml-10">Liberty Mutual Insurance Group | June 2025 - August 2025</h5>
            <ul className="ml-10 space-y-1 list-disc list-inside">
            ...
            <h1 className="text-2xl ml-10 mt-5">Software Engineer Intern</h1>
            <h5 className="text-lg ml-10">University of Maryland - Department of Astronomy | June 2023 - Present</h5>
            <ul className="ml-10 space-y-1 list-disc list-inside">
            ...
            <h1 className="text-2xl ml-10 mt-5">Spectroscopy Machine Learning Intern</h1>
            <h5 className="text-lg ml-10">NASA Goddard Flight Center | June 2023 - October 2024</h5>
            <ul className="ml-10 space-y-1 list-disc list-inside">
            ...
            <h1 className="text-2xl ml-10 mt-5">Machine Learning Research Intern</h1>
            <h5 className="text-lg ml-10">University of Maryland - Department of Computer Science | June 2023 - August 2023</h5>
            <ul className="ml-10 space-y-1 list-disc list-inside">
            ...
            <div className="flex flex-wrap">
                <h1 className="text-xl ml-10 mt-5 grow-1">Object Oriented Programming I and II</h1>
                <h1 className="text-xl ml-10 mt-5 grow-1">Introduction to Computer Systems</h1>
                <h1 className="text-xl ml-10 mt-5 grow-1">Discrete Structures</h1>
                <h1 className="text-xl ml-10 mt-5 grow-1">Organization of Programming Languages</h1>
                <h1 className="text-xl ml-10 mt-5 grow-1">Algorithms</h1>
                <h1 className="text-xl ml-10 mt-5 grow-1">Web Application Development with JavaScript</h1>
                <h1 className="text-xl ml-10 mt-5 grow-1">Introduction to Go</h1>
                <h1 className="text-xl ml-10 mt-5 grow-1">Object Oriented Programming I and II</h1>
            </div>

            <h1 className="text-3xl mt-10">Skills</h1>
            <div className="grid grid-cols-4 gap-10 items-end text-center mx-40 text-xl mb-20">
                <div className="flex flex-col items-center">
                    <Image src="/java.svg" alt="Java Logo" width={50} height={50}></Image>
